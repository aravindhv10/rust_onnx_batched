...
*** Implementations for the structure
#+begin_src rust :tangle ./src,main.rs
...
*** COMMENT Functions for constructing the struct
#+begin_src rust :tangle ./src,main.rs
...
*** Commit the changes
#+begin_src sh :shebang #!/bin/sh :results output :tangle ./.git.sh
  M 'UNVERIFIED: Started implementing functions for the prediction structure'
#+end_src
